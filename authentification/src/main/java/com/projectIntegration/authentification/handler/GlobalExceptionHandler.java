package com.projectIntegration.authentification.handler;


import com.projectIntegration.authentification.exception.ObjectValidationException;
import com.projectIntegration.authentification.exception.OperationNonPermittedException;
...
public class GlobalExceptionHandler {
    ...
    public ExceptionResponse handle(Exception exp) {
        ...
        return ExceptionResponse
                .builder()
                .errorMsg("Oups, an error has occurred. Please contat the admin")
                .build();
    }
